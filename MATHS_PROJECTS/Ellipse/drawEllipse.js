...
function drawEllipse(){
    ...
    connectColorCtx(Origin.x, Origin.y - minorAxis, Origin.x, Origin.y + minorAxis, ctx, 'yellow');
    connectColorCtx(Origin.x - majorAxis, Origin.y, Origin.x + majorAxis, Origin.y, ctx, 'cyan');
    ellipse.draw();
