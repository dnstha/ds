...
function Triangle(x1, y1, x2, y2, x3, y3){
    ...
    this.draw = () => {
        ...
        c.fillText("cosA = AB/CA \u2248 " + AB +"/" + CA + " \u2248 " + Math.round(EAB/ECA * 1000)/1000, canvas.width - 470, this.y2 + 63);
        c.fillText("tanA = BC/AB \u2248 " + BC +"/" + AB + " \u2248 " + Math.round(EBC/EAB * 1000)/1000, canvas.width - 470, this.y2 + 86);
    }
}
